...
On the tech side, I’ve built and explored labs and projects, including monitoring logs in Splunk, experimenting with Azure IAM, running SOAR and EDR workflows, and performing digital investigations using tools like Autopsy, Wireshark, Sleuth Kit, and Volatility.
